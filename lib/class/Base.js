...
const Jsl = require("../../config");
const { writeExifImg, writeExifVid } = require("../sticker");
const { isUrl, getBuffer } = require("../function");
const fs = require("fs");
...
class Video extends Base {
  ...
  _patch(data, msg) {
    ...
    this.sudo = Jsl.SUDO.split(",").includes(this.participant.split("@")[0]);
