...
async function isAdmin(Jsl,jid,sender) {	
	const groupMetadata = citel.isGroup ? await Jsl.groupMetadata(jid).catch((e) => {}) : "";
...
async function isBotAdmin(Jsl,jid,sender) {	
	const groupMetadata = citel.isGroup ? await Jsl.groupMetadata(citel.chat).catch((e) => {}) : "";
			  const participants = citel.isGroup ? await groupMetadata.participants : "";
			  const groupAdminss  = (participants) => {
				admins = []
				for (let i of participants) {
