...
const { jasil } = require(__dirname + '/database/group')
...
const { Module, commands } = require(__dirname + '/commands')
...
module.exports = {
    ...
    getAdmin: async(Jsl, abu) => {
        var adminn = await Jsl.groupMetadata(abu.chat);
        a = [];
