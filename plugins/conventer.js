...
function webp2mp4File(path) {
    ...
    Abu.addCommand({pattern: 'mp3$', fromMe: wk, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
...
thumbnail: White.tm_b });
   ...
   Abu.addCommand({pattern: 'mp4$', desc: Lang.ANİM_STİCK, fromMe: wk}, (async (message, match) => {
        const mid = message.jid
        ...
        await webp2mp4File(savedFilename).then(async (rest) => {
            await Axios({ method: "GET", url: rest.result, responseType: "stream"}).then(({ data }) => {
                ...
                saving.on("finish", async () => {
                    await message.client.sendMessage(mid, fs.readFileSync('/root/WhatsAbu/stweb.mp4'), MessageType.video, { mimetype: Mimetype.mp4, caption: '*ᴍᴀᴅᴇ ʙʏ ᴡʜɪᴛᴇ ᴅᴇᴠɪʟ*', quoted: message.data , 
thumbnail: White.tm_b })
    ...
    Abu.addCommand({pattern: 'doc ?(.*)', fromMe: wk, desc: doc_desc , usage : usge}, (async (message, match) => { 
    ...
    Abu.addCommand({pattern: 'tovideo ?(.*)', fromMe: wk, desc: 'convert audio to video' , usage : use}, (async (message, match) => { 
   ...
   Abu.addCommand({pattern: 'qrde ?(.*)', fromMe: wk, desc: 'convert audio to video' , usage : use}, (async (message, match) => { 
...
Abu.addCommand({pattern: 'me ?(.*)', fromMe: wk, desc: 'convert audio to video' , usage : use}, (async (message, match) => { 
