...
if (config.LANG == 'ML') {
  ...
  abu_desc = 'Auto bio mode മാറ്റാൻ'
...
Abu.addCommand({ pattern: 'autobio ?(.*)', fromMe: true, desc: abu_desc, usage: '.autobio on / off' }, (async (message, match) => {
