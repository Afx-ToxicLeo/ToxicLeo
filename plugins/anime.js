...
if (Config.WORKTYPE == 'private') {
    ...
    Abu.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    Abu.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
