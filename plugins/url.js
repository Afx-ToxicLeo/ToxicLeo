...
if (m.reply_message.sticker){
    return await m.client.sendMessage(m.jid,{text:"_"+(await webpUpload(await m.reply_message.downloadMediaMessage()))+"_"},{quoted: m.quoted})
}
    ...
    var q = await m.reply_message.downloadMediaMessage();
...
try { await m.client.sendMessage(m.jid,{text:"_"+(await upload(await m.reply_message.downloadMediaMessage())).link+"_"},{quoted: m.quoted}) } catch {return await m.client.sendMessage(m.jid,{text:"_Failed to upload file!_"},{quoted: m.quoted});}
}
