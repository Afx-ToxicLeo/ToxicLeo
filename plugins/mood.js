...
Abu.addCommand({pattern: 'mood ?(.*)', fromMe: true}, (async (message, match) => {
...
Abu.addCommand({pattern: 'infomood', fromMe: true}, (async (message, match) => {
    
    await message.sendMessage('*Codded by Afx-Abu*\n💻Usage: *.mood <reply>*\nℹ️Desc: Finds what your responding one‘s moods.\n🆕 _Support Filters!_');
