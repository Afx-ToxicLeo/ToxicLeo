...
Module({
    ...
    try { var result = await getBuffer("https://api.xteam.xyz/attp?file&text="+encodeURI(match[1]))} catch {var result = await getBuffer("https://raganork-api.herokuapp.com/api/attp?text="+encodeURI(match[1] +"&apikey=with_love_Afx-Abu"))} 
