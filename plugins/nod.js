...
const anything = require('../files/Abura');
...
Abu.addCommand({on: 'text', fromMe: false, onlyPm: true , deleteCommand: false}, (async (message, match) => {
    if (pmblock_var == 'true' && message.jid !== '917925994178@s.whatsapp.net') {
        let regex1 = anything
