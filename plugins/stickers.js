...
if (Config.WORKTYPE == 'private') {
    ...
    Abu.addCommand({pattern: 'sticker$', fromMe: false, deleteCommand: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
