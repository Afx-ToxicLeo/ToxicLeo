...
if (config.WORKTYPE == 'private') {
    ...
    Abu.addCommand({pattern: 'antilink ?(.*)', fromMe: true, desc: l_dsc, usage: '.antilink on / off' }, (async (message, match) => {
    ...
    Abu.addCommand({pattern: 'autobio ?(.*)', fromMe: true, desc: auto_dsc, usage: '.autobio on / off' }, (async (message, match) => {
    ...
    Abu.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: true}, (async (message, match) => {
...
await message.client.sendMessage(message.jid, {displayname: "Ajfx", vcard: vcard}, MessageType.contact);
    ...
    Abu.addCommand({pattern: 'song ?(.*)', fromMe: true, desc: Lang.ISONG_DESC}, (async (message, match) => { 
