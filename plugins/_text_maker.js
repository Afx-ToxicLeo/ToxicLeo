...
if (!encodeURIComponent(t[1])) return await m.reply("*Need text*")
...
if (typeof result_url === "number") return await m.reply("*Need "+result_url+" text!*\n*Ex: Text1,Text2*")
await m.reply({url: result_url},'image')  
});
