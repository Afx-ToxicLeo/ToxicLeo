...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    setInterval(async () => { 
        ...
        var ansk = 'https://gist.githubusercontent.com/Jinu-Xr/f731bf6fdfbc5072d6c995105c420ad8/raw'
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ ❤️ 𝙰𝙱𝚄 𝚂𝙴𝚁 💙 ~______~*' +
                                    '\n*💫 ʙᴏᴛɪɴ ᴄʜᴇʀɪʏᴀ ᴇɴᴛʜᴏ ᴘʀᴏʙʟᴏᴍs ʙᴜᴛ ɴᴏ ᴘʀᴏʙʟᴏᴍs ᴛʜɪs ɪsʜʜᴜ 🤭' +
                                    '\n\n*⚠️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
